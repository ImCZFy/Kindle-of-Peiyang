...
internal object BgEffectConfig {
    ...
    private val PHONE_LIGHT = Config(
        ...
        colors = floatArrayOf(0.57f, 0.76f, 0.98f, 1.0f, 0.98f, 0.85f, 0.68f, 1.0f, 0.98f, 0.75f, 0.93f, 1.0f, 0.73f, 0.70f, 0.98f, 1.0f),
        lightOffset = 0.1f,
        saturateOffset = 0.2f,
    )
    private val PHONE_DARK = Config(
        points = floatArrayOf(0.63f, 0.50f, 0.88f, 0.69f, 0.75f, 0.80f, 0.17f, 0.66f, 0.81f, 0.14f, 0.24f, 0.72f),
        colors = floatArrayOf(0.0f, 0.31f, 0.58f, 1.0f, 0.53f, 0.29f, 0.15f, 1.0f, 0.46f, 0.06f, 0.27f, 1.0f, 0.16f, 0.12f, 0.45f, 1.0f),
        lightOffset = -0.1f,
        saturateOffset = 0.2f,
    )

    internal fun get(deviceType: DeviceType, isDark: Boolean): Config = when (deviceType) {
        DeviceType.PHONE -> if (isDark) PHONE_DARK else PHONE_LIGHT
        DeviceType.PAD -> if (isDark) PHONE_DARK else PHONE_LIGHT
    }
}
